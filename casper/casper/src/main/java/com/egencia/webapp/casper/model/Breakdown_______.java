...
public class Breakdown_______ {
    ...
    private List<Breakdown________> breakdown = null;
    @JsonProperty("type")
    private String type;
     ...
     */
    @JsonProperty("breakdown")
    public List<Breakdown________> getBreakdown() {
        return breakdown;
    }
     ...
     */
    @JsonProperty("breakdown")
    public void setBreakdown(List<Breakdown________> breakdown) {
