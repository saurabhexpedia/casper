...
public class TravelerPrice_ {
    ...
    private List<Breakdown_________> breakdown = null;
    @JsonProperty("type")
    private String type;
     ...
     */
    @JsonProperty("breakdown")
    public List<Breakdown_________> getBreakdown() {
        return breakdown;
    }
     ...
     */
    @JsonProperty("breakdown")
    public void setBreakdown(List<Breakdown_________> breakdown) {
